...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)/usr/local/include $(IncludeSwitch)../include $(IncludeSwitch)/usr/include/eigen3 
IncludePCH             := 
RcIncludePath          := 
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/t/pf/test/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/test_rv_samp.cpp$(ObjectSuffix): test_rv_samp.cpp $(IntermediateDirectory)/test_rv_samp.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/t/pf/test/test_rv_samp.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test_rv_samp.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/test_resamplers.cpp$(ObjectSuffix): test_resamplers.cpp $(IntermediateDirectory)/test_resamplers.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/t/pf/test/test_resamplers.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test_resamplers.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/test_rv_eval.cpp$(ObjectSuffix): test_rv_eval.cpp $(IntermediateDirectory)/test_rv_eval.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/t/pf/test/test_rv_eval.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test_rv_eval.cpp$(ObjectSuffix) $(IncludePath)
