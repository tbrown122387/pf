...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
svol_apf<nparts, dimx, dimy, resampT, float_t>::svol_apf(const float_t &phi,
                                                         const float_t &beta,
                                                         const float_t &sigma)
    : APF<nparts, dimx, dimy, resampT, float_t>(), m_phi(phi), m_beta(beta),
      m_sigma(sigma) {}
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_apf<nparts, dimx, dimy, resampT, float_t>::propMu(const ssv &xtm1)
    -> ssv {
  return m_phi * xtm1;
}
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_apf<nparts, dimx, dimy, resampT, float_t>::q1Samp(const osv &y1)
    -> ssv {
  ssv x1samp(1);
  x1samp(0) =
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_apf<nparts, dimx, dimy, resampT, float_t>::fSamp(const ssv &xtm1)
    -> ssv {
  ssv xtsamp(1);
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t svol_apf<nparts, dimx, dimy, resampT, float_t>::logQ1Ev(const ssv &x1,
                                                                const osv &y1) {
  return rveval::evalUnivNorm<float_t>(
      x1(0), 0.0, m_sigma / std::sqrt(1.0 - m_phi * m_phi), true);
}
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t svol_apf<nparts, dimx, dimy, resampT, float_t>::logGEv(const osv &yt,
                                                               const ssv &xt) {
