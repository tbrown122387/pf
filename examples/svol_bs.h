...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
svol_bs<nparts, dimx, dimy, resampT, float_t>::svol_bs(const float_t &phi,
                                                       const float_t &beta,
                                                       const float_t &sigma)
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_bs<nparts, dimx, dimy, resampT, float_t>::q1Samp(const osv &y1)
    -> ssv {
  ssv x1samp;
  x1samp(0) =
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_bs<nparts, dimx, dimy, resampT, float_t>::fSamp(const ssv &xtm1)
    -> ssv {
  ssv xtsamp;
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t svol_bs<nparts, dimx, dimy, resampT, float_t>::logGEv(const osv &yt,
                                                              const ssv &xt) {
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_bs<nparts, dimx, dimy, resampT, float_t>::gSamp(const ssv &xt)
    -> osv {
  osv yt;
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t
svol_bs<nparts, dimx, dimy, resampT, float_t>::logQ1Ev(const ssv &x1samp,
                                                       const osv &y1) {
  return rveval::evalUnivNorm<float_t>(
