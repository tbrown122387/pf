...
svol_sisr<nparts, dimx, dimy, resampT, float_t>::svol_sisr(const float_t &phi,
                                                           const float_t &beta,
                                                           const float_t &sigma)
    : SISRFilter<nparts, dimx, dimy, resampT, float_t>(), m_phi(phi),
      m_beta(beta), m_sigma(sigma) {}

template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t
svol_sisr<nparts, dimx, dimy, resampT, float_t>::logMuEv(const ssv &x1) {
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_sisr<nparts, dimx, dimy, resampT, float_t>::q1Samp(const osv &y1)
    -> ssv {
  ssv x1samp;
  x1samp(0) =
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t
svol_sisr<nparts, dimx, dimy, resampT, float_t>::logQ1Ev(const ssv &x1,
                                                         const osv &y1) {
  return rveval::evalUnivNorm<float_t>(
      x1(0), 0.0, m_sigma / std::sqrt(1.0 - m_phi * m_phi), true);
}
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t svol_sisr<nparts, dimx, dimy, resampT, float_t>::logGEv(const osv &yt,
                                                                const ssv &xt) {
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t
svol_sisr<nparts, dimx, dimy, resampT, float_t>::logFEv(const ssv &xt,
                                                        const ssv &xtm1) {
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
auto svol_sisr<nparts, dimx, dimy, resampT, float_t>::qSamp(
    const ssv &xtm1, const osv &yt) -> ssv {
  ssv xtsamp;
...
template <size_t nparts, size_t dimx, size_t dimy, typename resampT,
          typename float_t>
float_t svol_sisr<nparts, dimx, dimy, resampT, float_t>::logQEv(const ssv &xt,
                                                                const ssv &xtm1,
                                                                const osv &yt) {
  return rveval::evalUnivNorm<float_t>(xt(0), m_phi * xtm1(0), m_sigma, true);
}
