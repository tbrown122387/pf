...
int main(int argc, char **argv) {
  ...
  acv_bs<numparts, dimstate, dimobs, fastMultinomR, FLOATTYPE> mod(
      var_s0, var_u0, var_s, var_u, scale_y, nu_y, Delta);
  ...
  using Mat = Eigen::Matrix<FLOATTYPE, Eigen::Dynamic,
                            Eigen::Dynamic>; // at each time point, which
                                             // approximates the
