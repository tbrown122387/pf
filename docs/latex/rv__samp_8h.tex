...
\item 
class \hyperlink{classpf_1_1rvsamp__base}{pf\+::rvsamp\+\_\+base$<$ dim $>$}
...
class \hyperlink{classpf_1_1UnivNormSampler}{pf\+::\+Univ\+Norm\+Sampler}
...
class \hyperlink{classpf_1_1MVNSampler}{pf\+::\+M\+V\+N\+Sampler$<$ dim $>$}
...
class \hyperlink{classpf_1_1UniformSampler}{pf\+::\+Uniform\+Sampler}
...
class \hyperlink{classpf_1_1k__gen}{pf\+::k\+\_\+gen$<$ N $>$}
\begin{DoxyCompactList}\small\item\em A class that performs sampling with replacement (useful for the index sampler in an \hyperlink{classpf_1_1APF}{A\+PF}) \end{DoxyCompactList}\end{DoxyCompactItemize}
