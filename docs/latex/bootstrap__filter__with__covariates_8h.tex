...
\begin{center}
\leavevmode
\includegraphics[width=349pt]{bootstrap__filter__with__covariates_8h__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em A base class for the boostrap particle filter with covariates. \end{DoxyCompactList}\end{DoxyCompactItemize}
